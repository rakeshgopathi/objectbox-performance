...
package io.objectbox.performanceapp.ui;
...
import io.objectbox.performanceapp.databinding.ActivityGlassMainBinding;
...
public class GlassMainActivity extends Activity implements Callback {
    ...
    private ActivityGlassMainBinding binding;
    private PerfTestRunner testRunner;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        binding = ActivityGlassMainBinding.inflate(getLayoutInflater());
        setContentView(binding.getRoot());

        binding.buttonRunTest.setOnClickListener(view -> {
            binding.relativeLayoutContainer.setVisibility(View.GONE);
            binding.scrollViewResults.setVisibility(View.VISIBLE);
            binding.buttonRunTest.setEnabled(false);
            View currentFocus = GlassMainActivity.this.getCurrentFocus();
            ...
            TestType type = (TestType) TestType.ALL[0];
        ...
        binding.buttonRunTest.requestFocusFromTouch();
        ...
        binding.editTextNumberEntities
                .setText(String.valueOf(prefs.getInt(PREF_COUNT, 1000)));
    ...
    public void done() {
        ...
        runOnUiThread(() -> {
            ...
            binding.relativeLayoutContainer.setVisibility(View.VISIBLE);
            binding.scrollViewResults.setVisibility(View.GONE);
